package vn.sjpn3.jlptn3.view.test;
...
import vn.sjpn3.jlptn3.db.DBSQLiteOpenHelper;
...
//		dbm = new yourCustomSqlLiteHelperclass(AndroidDatabaseManager.this);
        dbm = new DBSQLiteOpenHelper(AndroidDatabaseManager.this);
